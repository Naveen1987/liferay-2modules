...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=Attivita_Formativa_4 Portlet",
...
public class Attivita_Formativa_4Portlet extends MVCPortlet {
private final static Log log=LogFactoryUtil.getLog(Attivita_Formativa_4Portlet.class);
