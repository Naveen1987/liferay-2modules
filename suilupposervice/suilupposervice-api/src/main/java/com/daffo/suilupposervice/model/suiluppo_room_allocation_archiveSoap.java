 ...
 */
@ProviderType
public class suiluppo_room_allocation_archiveSoap implements Serializable {
	public static suiluppo_room_allocation_archiveSoap toSoapModel(
		suiluppo_room_allocation_archive model) {
		suiluppo_room_allocation_archiveSoap soapModel = new suiluppo_room_allocation_archiveSoap();

		soapModel.setRoom_allocat_archive_id(model.getRoom_allocat_archive_id());
		...
		soapModel.setRoom_archive_date(model.getRoom_archive_date());

		return soapModel;
	}

	public static suiluppo_room_allocation_archiveSoap[] toSoapModels(
		suiluppo_room_allocation_archive[] models) {
		suiluppo_room_allocation_archiveSoap[] soapModels = new suiluppo_room_allocation_archiveSoap[models.length];
	...
	public static suiluppo_room_allocation_archiveSoap[][] toSoapModels(
		suiluppo_room_allocation_archive[][] models) {
		suiluppo_room_allocation_archiveSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new suiluppo_room_allocation_archiveSoap[models.length][models[0].length];
		}
		else {
			soapModels = new suiluppo_room_allocation_archiveSoap[0][0];
		}
	...
	public static suiluppo_room_allocation_archiveSoap[] toSoapModels(
		List<suiluppo_room_allocation_archive> models) {
		List<suiluppo_room_allocation_archiveSoap> soapModels = new ArrayList<suiluppo_room_allocation_archiveSoap>(models.size());

		for (suiluppo_room_allocation_archive model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new suiluppo_room_allocation_archiveSoap[soapModels.size()]);
	}

	public suiluppo_room_allocation_archiveSoap() {
	}
