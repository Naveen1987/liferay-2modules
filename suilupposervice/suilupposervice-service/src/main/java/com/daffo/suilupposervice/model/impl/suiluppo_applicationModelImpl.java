...
import com.daffo.suilupposervice.model.suiluppo_applicationModel;
 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link suiluppo_applicationModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link suiluppo_applicationImpl}.
 * </p>
 *
 * @author Naveen
...
public class suiluppo_applicationModelImpl extends BaseModelImpl<suiluppo_application>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a suiluppo_application model instance should use the {@link suiluppo_application} interface instead.
	 */
	...
	static {
		TABLE_COLUMNS_MAP.put("applicat_id", Types.BIGINT);
		TABLE_COLUMNS_MAP.put("applicat_name", Types.VARCHAR);
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.daffo.suilupposervice.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.daffo.suilupposervice.model.suiluppo_application"),
			false);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.daffo.suilupposervice.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.daffo.suilupposervice.model.suiluppo_application"),
			false);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.daffo.suilupposervice.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.daffo.suilupposervice.model.suiluppo_application"),
			true);
	public static final long COURSE_ID_COLUMN_BITMASK = 1L;
	public static final long APPLICAT_ID_COLUMN_BITMASK = 2L;
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.daffo.suilupposervice.service.util.ServiceProps.get(
				"lock.expiration.time.com.daffo.suilupposervice.model.suiluppo_application"));
	...
	private static final ClassLoader _classLoader = suiluppo_application.class.getClassLoader();
