...
import com.daffo.suilupposervice.model.suiluppo_courseModel;
 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link suiluppo_courseModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link suiluppo_courseImpl}.
 * </p>
 *
 * @author Naveen
...
public class suiluppo_courseModelImpl extends BaseModelImpl<suiluppo_course>
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("Docente", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("Evento_Progetto", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("Titolo", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("Descrizione", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("Figure_Professionali_Coinvolte", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("Data_Inizio", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("Data_Fine", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("Tot_Ore", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("Nr_Edizione", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("Sede", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("Abstract", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("Dispensa_corso", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("Ammessi_al_corso", Types.BIGINT);
		TABLE_COLUMNS_MAP.put("Scadenza_Iscrizioni", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("Visibile", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("Bloccato", Types.VARCHAR);
	}
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.daffo.suilupposervice.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.daffo.suilupposervice.model.suiluppo_course"),
			false);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.daffo.suilupposervice.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.daffo.suilupposervice.model.suiluppo_course"),
			false);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.daffo.suilupposervice.service.util.ServiceProps.get(
				"lock.expiration.time.com.daffo.suilupposervice.model.suiluppo_course"));
	...
	public String toXmlString() {
		...
		sb.append("com.daffo.suilupposervice.model.suiluppo_course");
	...
	private static final ClassLoader _classLoader = suiluppo_course.class.getClassLoader();
