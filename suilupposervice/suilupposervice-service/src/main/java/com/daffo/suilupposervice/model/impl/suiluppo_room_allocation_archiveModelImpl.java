...
import com.daffo.suilupposervice.model.suiluppo_room_allocation_archiveModel;
 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link suiluppo_room_allocation_archiveModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link suiluppo_room_allocation_archiveImpl}.
 * </p>
 *
 * @author Naveen
...
public class suiluppo_room_allocation_archiveModelImpl extends BaseModelImpl<suiluppo_room_allocation_archive>
	...
	static {
		TABLE_COLUMNS_MAP.put("room_allocat_archive_id", Types.BIGINT);
		...
		TABLE_COLUMNS_MAP.put("room_archive_date", Types.VARCHAR);
	}
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.daffo.suilupposervice.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.daffo.suilupposervice.model.suiluppo_room_allocation_archive"),
			false);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.daffo.suilupposervice.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.daffo.suilupposervice.model.suiluppo_room_allocation_archive"),
			false);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.daffo.suilupposervice.service.util.ServiceProps.get(
				"lock.expiration.time.com.daffo.suilupposervice.model.suiluppo_room_allocation_archive"));
	...
	private static final ClassLoader _classLoader = suiluppo_room_allocation_archive.class.getClassLoader();
