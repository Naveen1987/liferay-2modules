...
import com.daffo.suilupposervice.model.suiluppo_room_allocationModel;
 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link suiluppo_room_allocationModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link suiluppo_room_allocationImpl}.
 * </p>
 *
 * @author Naveen
...
public class suiluppo_room_allocationModelImpl extends BaseModelImpl<suiluppo_room_allocation>
	...
	static {
		TABLE_COLUMNS_MAP.put("room_allocat_id", Types.BIGINT);
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.daffo.suilupposervice.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.daffo.suilupposervice.model.suiluppo_room_allocation"),
			false);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.daffo.suilupposervice.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.daffo.suilupposervice.model.suiluppo_room_allocation"),
			false);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.daffo.suilupposervice.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.daffo.suilupposervice.model.suiluppo_room_allocation"),
			true);
	public static final long COURSE_ID_COLUMN_BITMASK = 1L;
	public static final long ROOMID_COLUMN_BITMASK = 2L;
	public static final long ROOM_ALLOCAT_ID_COLUMN_BITMASK = 4L;
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.daffo.suilupposervice.service.util.ServiceProps.get(
				"lock.expiration.time.com.daffo.suilupposervice.model.suiluppo_room_allocation"));
	...
	private static final ClassLoader _classLoader = suiluppo_room_allocation.class.getClassLoader();
