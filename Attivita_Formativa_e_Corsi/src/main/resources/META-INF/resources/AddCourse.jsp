...
<tbody>
<tr>
<td>Docente<span style="font-size:20px;color:red"><b>*</b></span></td><td><input type="text" id="Docente" name="<portlet:namespace/>Docente" placeholder="Enter Docente" value="<%=user.getFullName()%>" class="form-control" />
