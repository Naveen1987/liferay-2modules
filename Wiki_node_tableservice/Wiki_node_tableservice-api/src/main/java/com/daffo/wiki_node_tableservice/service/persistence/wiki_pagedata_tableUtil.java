...
/**
 * The persistence utility for the wiki_pagedata_table service. This utility wraps {@link com.daffo.wiki_node_tableservice.service.persistence.impl.wiki_pagedata_tablePersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 */
@ProviderType
public class wiki_pagedata_tableUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(wiki_pagedata_table wiki_pagedata_table) {
		getPersistence().clearCache(wiki_pagedata_table);
	}
	 ...
	 */
	public static List<wiki_pagedata_table> findWithDynamicQuery(
	 ...
	 */
	public static wiki_pagedata_table update(
		wiki_pagedata_table wiki_pagedata_table) {
		return getPersistence().update(wiki_pagedata_table);
	}
	 ...
	 */
	public static wiki_pagedata_table update(
		wiki_pagedata_table wiki_pagedata_table, ServiceContext serviceContext) {
		return getPersistence().update(wiki_pagedata_table, serviceContext);
	}
	...
	*/
	public static List<wiki_pagedata_table> findByPageID(long PageID) {
	...
	*/
	public static wiki_pagedata_table findByPageID_First(long PageID,
		OrderByComparator<wiki_pagedata_table> orderByComparator)
		throws com.daffo.wiki_node_tableservice.exception.NoSuchwiki_pagedata_tableException {
	...
	*/
	public static wiki_pagedata_table fetchByPageID_First(long PageID,
		OrderByComparator<wiki_pagedata_table> orderByComparator) {
	...
	* @throws NoSuchwiki_pagedata_tableException if a matching wiki_pagedata_table could not be found
	*/
	public static wiki_pagedata_table findByPageID_Last(long PageID,
		OrderByComparator<wiki_pagedata_table> orderByComparator)
		throws com.daffo.wiki_node_tableservice.exception.NoSuchwiki_pagedata_tableException {
	...
	*/
	public static wiki_pagedata_table fetchByPageID_Last(long PageID,
		OrderByComparator<wiki_pagedata_table> orderByComparator) {
	...
	*/
	public static wiki_pagedata_table[] findByPageID_PrevAndNext(
		long Page_ModID, long PageID,
		OrderByComparator<wiki_pagedata_table> orderByComparator)
		throws com.daffo.wiki_node_tableservice.exception.NoSuchwiki_pagedata_tableException {
		return getPersistence()
				   .findByPageID_PrevAndNext(Page_ModID, PageID,
			orderByComparator);
	}
	...
	*/
	public static void cacheResult(wiki_pagedata_table wiki_pagedata_table) {
		getPersistence().cacheResult(wiki_pagedata_table);
	}
	...
	*/
	public static void cacheResult(
		List<wiki_pagedata_table> wiki_pagedata_tables) {
		getPersistence().cacheResult(wiki_pagedata_tables);
	}
	...
	*/
	public static wiki_pagedata_table create(long Page_ModID) {
		return getPersistence().create(Page_ModID);
	}
	...
	* @throws NoSuchwiki_pagedata_tableException if a wiki_pagedata_table with the primary key could not be found
	*/
	public static wiki_pagedata_table remove(long Page_ModID)
		throws com.daffo.wiki_node_tableservice.exception.NoSuchwiki_pagedata_tableException {
		return getPersistence().remove(Page_ModID);
	}

	public static wiki_pagedata_table updateImpl(
		wiki_pagedata_table wiki_pagedata_table) {
		return getPersistence().updateImpl(wiki_pagedata_table);
	}
	...
	* @throws NoSuchwiki_pagedata_tableException if a wiki_pagedata_table with the primary key could not be found
	*/
	public static wiki_pagedata_table findByPrimaryKey(long Page_ModID)
		throws com.daffo.wiki_node_tableservice.exception.NoSuchwiki_pagedata_tableException {
		return getPersistence().findByPrimaryKey(Page_ModID);
	}
	...
	*/
	public static wiki_pagedata_table fetchByPrimaryKey(long Page_ModID) {
		return getPersistence().fetchByPrimaryKey(Page_ModID);
	}

	public static java.util.Map<java.io.Serializable, wiki_pagedata_table> fetchByPrimaryKeys(
	...
	*/
	public static List<wiki_pagedata_table> findAll() {
	...
	*/
	public static List<wiki_pagedata_table> findAll(int start, int end) {
	...
	*/
	...
	public static wiki_pagedata_tablePersistence getPersistence() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<wiki_pagedata_tablePersistence, wiki_pagedata_tablePersistence> _serviceTracker =
		ServiceTrackerFactory.open(wiki_pagedata_tablePersistence.class);
}