...
/**
 * Provides the local service interface for wiki_pagedata_table. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see wiki_pagedata_tableLocalServiceUtil
...
public interface wiki_pagedata_tableLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link wiki_pagedata_tableLocalServiceUtil} to access the wiki_pagedata_table local service. Add custom service methods to {@link com.daffo.wiki_node_tableservice.service.impl.wiki_pagedata_tableLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
