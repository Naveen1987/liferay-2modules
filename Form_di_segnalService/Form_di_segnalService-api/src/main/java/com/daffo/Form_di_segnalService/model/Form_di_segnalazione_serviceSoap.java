 ...
 */
@ProviderType
public class Form_di_segnalazione_serviceSoap implements Serializable {
	public static Form_di_segnalazione_serviceSoap toSoapModel(
		Form_di_segnalazione_service model) {
		Form_di_segnalazione_serviceSoap soapModel = new Form_di_segnalazione_serviceSoap();
	...
	public static Form_di_segnalazione_serviceSoap[] toSoapModels(
		Form_di_segnalazione_service[] models) {
		Form_di_segnalazione_serviceSoap[] soapModels = new Form_di_segnalazione_serviceSoap[models.length];
	...
	public static Form_di_segnalazione_serviceSoap[][] toSoapModels(
		Form_di_segnalazione_service[][] models) {
		Form_di_segnalazione_serviceSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new Form_di_segnalazione_serviceSoap[models.length][models[0].length];
		}
		else {
			soapModels = new Form_di_segnalazione_serviceSoap[0][0];
		}
	...
	public static Form_di_segnalazione_serviceSoap[] toSoapModels(
		List<Form_di_segnalazione_service> models) {
		List<Form_di_segnalazione_serviceSoap> soapModels = new ArrayList<Form_di_segnalazione_serviceSoap>(models.size());

		for (Form_di_segnalazione_service model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new Form_di_segnalazione_serviceSoap[soapModels.size()]);
	}

	public Form_di_segnalazione_serviceSoap() {
	}
