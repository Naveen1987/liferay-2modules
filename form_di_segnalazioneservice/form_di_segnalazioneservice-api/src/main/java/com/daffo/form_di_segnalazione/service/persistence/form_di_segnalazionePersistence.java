...
/**
 * The persistence interface for the form_di_segnalazione service.
 *
 * <p>
 ...
 */
@ProviderType
public interface form_di_segnalazionePersistence extends BasePersistence<form_di_segnalazione> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link form_di_segnalazioneUtil} to access the form_di_segnalazione persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public void cacheResult(
		java.util.List<form_di_segnalazione> form_di_segnalaziones);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, form_di_segnalazione> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<form_di_segnalazione> findAll();
	...
	*/
	public java.util.List<form_di_segnalazione> findAll(int start, int end);
	...
	*/
	public java.util.List<form_di_segnalazione> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<form_di_segnalazione> orderByComparator);
