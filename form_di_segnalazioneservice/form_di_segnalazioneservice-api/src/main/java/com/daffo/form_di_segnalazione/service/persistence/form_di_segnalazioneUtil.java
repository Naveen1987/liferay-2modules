...
/**
 * The persistence utility for the form_di_segnalazione service. This utility wraps {@link com.daffo.form_di_segnalazione.service.persistence.impl.form_di_segnalazionePersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see com.daffo.form_di_segnalazione.service.persistence.impl.form_di_segnalazionePersistenceImpl
 * @generated
 */
@ProviderType
public class form_di_segnalazioneUtil {
	...
	*/
	public static void cacheResult(form_di_segnalazione form_di_segnalazione) {
	...
	*/
	public static void cacheResult(
		List<form_di_segnalazione> form_di_segnalaziones) {
	...
	*/
	public static form_di_segnalazione create(long Form_di_segnalazione_id) {
	...
	*/
	public static form_di_segnalazione remove(long Form_di_segnalazione_id)
		throws com.daffo.form_di_segnalazione.exception.NoSuchform_di_segnalazioneException {
		return getPersistence().remove(Form_di_segnalazione_id);
	}

	public static form_di_segnalazione updateImpl(
		form_di_segnalazione form_di_segnalazione) {
	...
	* @throws NoSuchform_di_segnalazioneException if a form_di_segnalazione with the primary key could not be found
	*/
	public static form_di_segnalazione findByPrimaryKey(
	...
	*/
	public static form_di_segnalazione fetchByPrimaryKey(
		long Form_di_segnalazione_id) {
		return getPersistence().fetchByPrimaryKey(Form_di_segnalazione_id);
	}

	public static java.util.Map<java.io.Serializable, form_di_segnalazione> fetchByPrimaryKeys(
	...
	*/
	public static List<form_di_segnalazione> findAll() {
	...
	*/
	public static List<form_di_segnalazione> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<form_di_segnalazionePersistence, form_di_segnalazionePersistence> _serviceTracker =
		ServiceTrackerFactory.open(form_di_segnalazionePersistence.class);
}