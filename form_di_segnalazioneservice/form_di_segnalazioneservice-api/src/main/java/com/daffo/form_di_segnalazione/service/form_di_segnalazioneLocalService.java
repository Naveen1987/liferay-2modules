...
/**
 * Provides the local service interface for form_di_segnalazione. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see form_di_segnalazioneLocalServiceUtil
...
public interface form_di_segnalazioneLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link form_di_segnalazioneLocalServiceUtil} to access the form_di_segnalazione local service. Add custom service methods to {@link com.daffo.form_di_segnalazione.service.impl.form_di_segnalazioneLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
