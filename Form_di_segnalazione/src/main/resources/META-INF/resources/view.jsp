...
<tr><td><input class="form-control" style="background-color: #eee" name="<portlet:namespace/>INIZIALI_1">
</td></tr></tbody></table> 
</div> 
<div class="col-md-2"> 
...
<div class="col-md-2"> 
<table><tbody><tr><td>CODICE SEGNALAZIONE<br>&nbsp;</td></tr><tr><td> <input class="form-control" style="background-color: #eee" name="<portlet:namespace/>CODICE"> </td></tr></tbody></table>
</div> 
</div> 
...
<tr> <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="<portlet:namespace/>ESITO_10_7" value="il farmaco puÃ² avere contribuito"> il farmaco puÃ² avere contribuito</td></tr> 
...
<div class="col-md-4"> 
 ...
 <tr> <td><input type="reset" value="Reset" style="width:200px;background-color:#e60000 ;color:white; height:40px">
  <input type="submit" value="Submit" style="width:200px;background-color:#006622;color:white; height:40px"></td>
</tr>
</tbody>
</table>
</div>
