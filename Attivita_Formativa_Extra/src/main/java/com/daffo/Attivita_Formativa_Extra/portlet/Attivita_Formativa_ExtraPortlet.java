package com.daffo.Attivita_Formativa_Extra.portlet;
...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=Attivita_Formativa_Extra Portlet",
...
public class Attivita_Formativa_ExtraPortlet extends MVCPortlet {
private final static Log log=LogFactoryUtil.getLog(Attivita_Formativa_ExtraPortlet.class);
