...
/**
 * Provides the local service interface for prontuario_drug. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see prontuario_drugLocalServiceUtil
...
public interface prontuario_drugLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link prontuario_drugLocalServiceUtil} to access the prontuario_drug local service. Add custom service methods to {@link com.daffo.prontuario_drugservice.service.impl.prontuario_drugLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
